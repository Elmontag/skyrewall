const en = {
  ...
  followersOnly: 'Followers only (exclude main account)',
  followersOnlyHint: 'The target account itself will not be blocked/muted — only its followers.',
  followersOnlyBadge: 'Followers only',
  includeMainAccount: 'incl. main account',
  listUri: 'List URI',
  subTypeList: 'List',
  subListUri: 'List URI',
};
