...
const de: Translations = {
  ...
  followersOnly: 'Nur Follower (Hauptaccount ausschließen)',
  followersOnlyHint: 'Der Ziel-Account selbst wird nicht geblockt/gemutet — nur seine Follower.',
  followersOnlyBadge: 'Nur Follower',
  includeMainAccount: 'inkl. Hauptaccount',
  listUri: 'Listen-URI',
  subTypeList: 'Liste',
